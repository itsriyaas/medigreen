    ...
    {/* Banner */}
        ...
        <Container className="py-5">
          <Row className="align-items-center">
            ...
            <Col md={6} data-aos="fade-right">
              ...
              Medigreen Hospital was commissioned on 7th January 2017 under the visionary leadership of <strong>Mr. Ragesh Manu S.R, Managing Director</strong> and his wife <strong>Dr. Ajirani MD [Ukraine]</strong> to take care of all medical needs. Medigreen Hospital come up with an expert insight into health services has set highest standards for quality and care to ensure top-notch healthcare experience.
               ...
               <p className="text-justify">
                The hospital designed and conceived in a different way sprawls in 50 cents of land adjacent to Thrissur Kodungallur main road. Medigreen Hospital is equipped with an operation theatre, intensive care unit, 24-Hour Accident & Emergency care unit, most modern radiological equipment, 24 Hour Pharmacy and clinical Laboratories,  operation theatre, full fledged medical ICU,  PRP [Platelet-Rich Plasma] and GFC [Growth Factor Concentrate] therapy for moderate hair loss and skin rejuvenation are given at budget friendly option,  ample car parking facilities and more.
              </p>
              <p className="text-justify">
            ...
            {/* Right Column - Image */}
            <Col md={6}  data-aos="fade-right" className="text-center mt-4 mt-md-0">
              <img
